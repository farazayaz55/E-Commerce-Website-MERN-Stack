const Users = require('../models/userModel')//we need user model
...
const userCtrl = {
    register: async (req, res) =>{
        try {
            const {name, email, password} = req.body;//req is a json object which has data from client side
            ...
            //req params gives the info from url
            ...
            //req body has data from post or put call
            //all the data passed from client side post or put has data in req.body
            //like the form data is in req.body
            const user = await Users.findOne({email})
            //there are different build in model function in Nodejs for model handling
            //such as findOne and many other can be found from findone definition file
